...
This tool has been deactivated as a precaution. **Please unlink and relink your Habitica account**  again to continue using it. You can do so from [your account page](${ habitoolsUrl }/my-account/).
